...
- [Prepare the environment to use the OpenStack API](../platform/public-cloud/prepare_the_environment_for_using_the_openstack_api/guide.en-au.md){.ref} with the python-swiftclient client
