...
First, login to your server's page in your [OVHcloud Control Panel][OVHcloud Control Panel](https://ca.ovh.com/auth/?action=gotomanager){.external}. Once there, select the `IPMI`{.action} tab.
